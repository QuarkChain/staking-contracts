...
contract W3qNative {
    ...
    function getEthereumLog(uint256 chainId , bytes32 txHash, uint256 logIdx ,uint256 maxDataLen, uint256 confirms) public returns(address,bytes32[] memory,bytes memory){
